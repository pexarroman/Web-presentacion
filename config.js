...
window.SITE_CONFIG = {
  ...
  meta: {
    title: "Runlab – Tu recuperación es tu salud",
    description: "Runlab – Tus logros lo primero",
    lang: "es"
  },
  ...
  hero: {
    locationBadge: "Ibiza, Madrid",
    titleLine1: "Muévete sin dolor",
    titleHighlight: "Clínica de rehabilitación y fisioterapia en Madrid",
    ...
    googleRating: "5/5",
    collegiatedText: "Fisioterapeutas colegiados, especializados en corredores",
  ...
  services: [
    ...
    },
    {
      ...
      description: "60 min (grupos de 4 personas)",
      price: "30€",
      priceUnit: "/ sesión"
    },
    {
  ...
  whyUs: [
    ...
    {
      icon: "map-pin",
      title: "A un paseo de tu casa",
      description: "Ubicados en pleno Ibiza, con fácil aparcamiento y acceso en transporte público."
    },
    {
      icon: "calendar-clock",
  ...
  trainerSection: {
    ...
    heading: "Rafael Pazos",
    role: "Fisioterapeuta colegiado",
    imageCaption: "Foto de Rafael Pazos",
  ...
  contactSection: {
    eyebrow: "Contacto",
    heading: "Estamos en Ibiza, ven a conocernos",
    description: "Pide tu cita por teléfono, WhatsApp o pásate directamente por la clínica en nuestro horario de atención."
  },

  // ---------- Footer ----------
  footer: {
    description: "Clínica de fisioterapia en Goya, Madrid"
  }
};
